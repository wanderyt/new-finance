...
interface PersonCategoryPieChartProps {
  data: PersonCategoryData[];
  height?: number;
}
...
export default function PersonCategoryPieChart({
  data,
  height = 200,
}: PersonCategoryPieChartProps) {
